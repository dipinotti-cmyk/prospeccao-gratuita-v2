...
${isEmail
  ...
  for (const candidato of fila) {
    ...
    // 429 é limite por minuto e já foi reesperado acima. 503 é modelo
    // sobrecarregado no Google, 404 é modelo aposentado e 400 é parâmetro
    // recusado: em todos, trocar de modelo resolve mais rápido que insistir.
    if (!resp.ok) {
