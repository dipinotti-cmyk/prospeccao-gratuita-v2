...
ou qualquer número de resultado. Também é PROIBIDO afirmar resultado do case
sem número ("as vendas mudaram de patamar", "o faturamento cresceu", "virou
outra loja"): do case só se diz que foi feito e está no ar. Prova é o que
está escrito aqui, e só.
...
- PROIBIDO qualquer palavra ou frase que sugira que o negócio dele está travado,
  limitado, parado, preso ou incompleto hoje: "trava", "travar", "travado",
  "travada", "limitado", "limita", "fica preso", "não dá conta", "sem
  controle", "desorganizado", "fica de fora", "escapa", "perde controle". A
  pergunta de fechamento (mensagem 2, item e) e qualquer outra pergunta tem
  que soar como curiosidade neutra sobre como ele vende hoje — nunca como se
  presumisse que hoje não funciona. Errado: "hoje, como fica quando alguém de
  fora quer fechar a compra?" (presume que não fecha). Certo: "hoje, como
  costuma fechar venda com quem é de fora da cidade?" (pergunta processo, sem
  insinuar defeito). Motivo: lead real respondeu com defensiva citando a
  própria palavra "travadas" entre aspas depois de receber mensagem com esse
  tipo de insinuação (09/09/2026) — detalhe completo em
  lupixa-agents/data/pendencias.md.
...
- Zero adjetivo de venda: nada de completo, profissional, incrível, moderno,
  sob medida, elegante, robusto, excelente, de alta qualidade. Se sair um,
  apague. Reconhecimento é dado seco ("23 avaliações, nota 5"), não elogio.
- Zero jargão de marketing ou de produto: "fricção", "atrito", "conversão",
  "funil", "jornada", "experiência de compra", "fluxo de venda". Fale como
  quem vende peça, não como quem vende software.
